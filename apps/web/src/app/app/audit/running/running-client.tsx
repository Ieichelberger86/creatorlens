...
const PHASES: Array<{ match: string; phase: string; weight: number }> = [
  { match: "scrape", phase: "Pulling your videos", weight: 50 },
  { match: "voice", phase: "Distilling your voice", weight: 15 },
  { match: "audit", phase: "Writing your audit", weight: 35 },
];

export function AuditRunningClient() {
    ...
    <main className="relative mx-auto flex min-h-[calc(100dvh-57px)] w-full max-w-xl flex-1 flex-col px-6 py-10">
      ...
      <div className="relative z-10 flex flex-1 flex-col">
        ...
        <p className="mb-6 text-sm text-fg-muted">
          Pulling your full TikTok history (up to 100 videos), re-distilling
          your voice, and writing a fresh audit. Usually 90–180 seconds for a
          full profile.
        </p>
        ...
        <div className="mt-auto pt-8 text-center text-[11px] text-fg-subtle">
          Stay on this page — we&apos;ll route you to the fresh audit when
          it&apos;s ready.
        </div>
      </div>
    </main>
